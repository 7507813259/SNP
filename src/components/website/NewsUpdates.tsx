...
const newsItems = [
  {
    id: 1,
    title:
      'उमेदवार थकबाकी ना-हरकत प्रमाणपत्र कक्ष येथे निवडणूक अधिकारी यांची भेट',
    image: '',
  ...
  },
  {
    id: 2,
    title:
      'शेगांव क्षेत्रीय कार्यालयात निवडणूक सुरक्षा व कायदा-सुव्यवस्थेबाबत समन्वय बैठक',
    image: '',
  ...
  {
    id: 3,
    title: 'शेगांव नगर परिषद सार्वत्रिक निवडणूक २०२५-२६ अनुषंगाने बैठक संपन्न',
    image: '',
      ...
      <div className='relative mx-auto max-w-7xl px-6'>
        ...
        <div className='mb-12 text-center'>
          ...
          <p className='mx-auto max-w-2xl text-lg text-gray-600'>
            शेगांव नगर परिषदेच्या नवीनतम घडामोडी, बैठका आणि महत्त्वाच्या घटनांची
            माहिती
          </p>
        </div>
